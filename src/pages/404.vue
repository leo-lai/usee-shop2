<template>
  <div class="l-page">
    <header class="mui-bar mui-bar-nav l-black" v-if="!$device.isWechat">
      <h1 class="mui-title">找不到页面</h1>
      <a class="mui-icon mui-icon-arrowleft mui-pull-left _nav-back"></a>
    </header>
    <div class="mui-content" style="background:#404853;">
      <br><br>
      <p class="l-text-center" style="color:#fff; text-shadow:1px 2px 5px #fff; ">哎呀！我迷路了~</p>
      <div class="l-robot-men">
        <svg id="robot" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="320px" height="300px" viewBox="0 0 160 300" enable-background="new 0 0 320 300" xml:space="preserve">
          ...
          <g id="head" class="up">
            <g id="leftAntenna">
              <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 77.519 25.869 C 75.85 13.604 65.745 3.39 53.972 0.0292256">
              ...
              <ellipse fill="#ccc" cx="55.021" cy="0.0292256" rx="3.344" ry="3.391">
            ...
            <g id="rightAntenna">
              <path fill="none" stroke="#ccc" stroke-width="1.5" stroke-miterlimit="10" d="M 82.48 25.869 C 84.15 13.604 94.255 3.39 106.028 -4.50735">
              ...
              <ellipse fill="#ccc" cx="104.979" cy="-4.50735" rx="3.344" ry="3.391">
          ...
          C118.309,65.694,118.625,47.035,112.809,28.372z"></path>
            <g>
              <g id="eyeLeft">
                <path fill="#FFFFFF" d="M 72.116 47.955 c 0 5.443 -0.0992355 9.853 -9.033 9.853 h -1.971 c -4.988 0 -9.032 -4.41 -9.032 -9.853 s 4.044 -4.92379 9.032 -4.92379 h 1.971 C 68.071 45.0041 72.116 42.512 72.116 47.955 Z">
              ...
              <g>
                <path fill="#FFFFFF" d="M 107.92 47.955 c 0 5.443 -4.045 9.853 -9.031 9.853 h -1.973 c -4.986 0 -9.031 -4.41 -9.031 -9.853 s 4.045 -4.92379 9.031 -4.92379 h 1.973 C 103.875 45.0041 107.92 42.512 107.92 47.955 Z">
                  <animate attributeName="d" calcMode="spline" keySplines="0.42 0 0.58 1; 0.42 0 0.58 1" begin="5s" dur="0.8s" repeatCount="indefinite" values="
            ...
            <path fill="#FFFFFF" d="M 103.383 69.778 c 0 1.381 -0.855508 2.68189 -1.871 2.499 c -11.1746 -2.03695 -30.3889 -1.78904 -43.025 0 c -1.02162 0.138994 -1.871 -1.118 -1.871 -2.499 c 0 -1.378 0.880267 -2.75854 1.871 -2.496 c 14.3609 4.06008 30.7734 2.79044 43.025 0 C 102.518 67.0609 103.383 68.4 103.383 69.778 Z">
      ...
      <div class="col" style="margin-top:-2rem;"> <h4>404</h4> </div>
      <br>
      
      <br>
      <div class="l-text-center">
        <button @click="goHome">带我回家</button>
      </div>
    </div>
  </div>
</template>
...
.l-robot-men{transform: scale(0.5)}
svg#robot {
  display: block;
  position: relative;
  margin: 0 auto;
...
button{
  background: none; border:1px solid #fff; color: #fff; width: 6rem; box-shadow: 0 0 9px #fff;
}
</style>